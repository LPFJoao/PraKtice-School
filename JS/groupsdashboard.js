...
class GroupsManager {
    constructor() {
        this.groups = [
            {
                id: 1,
                name: "Groupe d'étude Mathématiques Informatique",
                description: "Groupe d'étude pour les cours de mathématiques avancées et informatique. Révisions, exercices et entraide.",
                type: "study",
                members: [
